...
export default class App extends Component<{}, {fontsLoaded: boolean, selectedFont: string}> {
    fonts = {};
    constructor(props: object) {
        super(props);
        this.state = {fontsLoaded: false, selectedFont: 'Handlee'};
    }
            ...
            return (
                <View style={styles.container}>
                    <Picker
                        ...
                        onValueChange={(itemValue, itemIndex) => this.setState({selectedFont: itemValue})}
                    >
                        <Picker.Item label="Handlee" value="Handlee"/>
                        <Picker.Item label="Just Another Hand" value="Just Another Hand"/>
                        {/*{Object.keys(this.fonts).map(fontName => <Picker.Item label={fontName} value={fontName}/>)}*/}
                    </Picker>
                    <TextInput style={{fontFamily: this.state.selectedFont, fontSize: 40}} placeholder="Type here..."></TextInput>
                </View>
            );
        }
    }
